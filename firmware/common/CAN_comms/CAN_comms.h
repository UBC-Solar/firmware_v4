 ...
 * This header contains user facing functions declarations and structs for the CAN communications
 * layer.
 *
 ...
 * @param CAN_comms_Rx_callback: A function pointer to the callback function that is called when a
 * CAN message is ready to be parsed.
 */
typedef struct
{
