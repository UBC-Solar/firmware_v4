...
typedef enum {
    ...
    FAULT_SPARE_FUSE       = (1U << 2), // 0b00100
    FAULT_SPARE_CTRL_FUSE  = (1U << 3), // 0b01000
    FAULT_ESTOP            = (1U << 4), // 0b10000
} FaultSource_t;
/**
...
/** @return Total number of times HAL_GPIO_EXTI_Callback has fired since boot. */
