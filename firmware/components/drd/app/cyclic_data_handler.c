...
{
    CYCLIC_DATA_SET(cyclic_mppta_temperature, temperature);
}
void CyclicDataSetMpptBTemperature(uint8_t temperature)
{
    CYCLIC_DATA_SET(cyclic_mpptb_temperature, temperature);
}
void CyclicDataSetMpptCTemperature(uint8_t temperature)
{
    CYCLIC_DATA_SET(cyclic_mpptc_temperature, temperature);
}
void CyclicDataSetMpptDTemperature(uint8_t temperature)
{
    CYCLIC_DATA_SET(cyclic_mpptd_temperature, temperature);
}
void CyclicDataSetBatteryMinTemperature(uint8_t temperature)
{
    CYCLIC_DATA_SET(cyclic_batt_min_temperature, temperature);
}
void CyclicDataSetBatteryMaxTemperature(uint8_t temperature)
{
    CYCLIC_DATA_SET(cyclic_batt_max_temperature, temperature);
}
void CyclicDataSetMtrContTemperature(uint8_t temperature)
{
    CYCLIC_DATA_SET(cyclic_mtr_cont_temperature, temperature);
}
void CyclicDataSetMtrThermTemperature(uint8_t temperature)
{
    CYCLIC_DATA_SET(cyclic_mtr_therm_temperature, temperature);
}
...
{
    return CYCLIC_DATA_GET(cyclic_batt_min_temperature);
}
uint8_t* CyclicDataGetBatteryMaxTemperature(void)
{
    return CYCLIC_DATA_GET(cyclic_batt_max_temperature);
}
uint8_t* CyclicDataGetMtrContTemperature(void)
{
    return CYCLIC_DATA_GET(cyclic_mtr_cont_temperature);
}
uint8_t* CyclicDataGetMtrThermTemperature(void)
{
    return CYCLIC_DATA_GET(cyclic_mtr_therm_temperature);
}
