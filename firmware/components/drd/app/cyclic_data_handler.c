...
void set_cyclic_pack_current(int16_t current) { CYCLIC_DATA_SET(cyclic_pack_current, current); }

void set_cyclic_pack_voltage(uint16_t voltage) { CYCLIC_DATA_SET(cyclic_pack_voltage, voltage); }

void set_cyclic_drive_state(uint8_t state) { CYCLIC_DATA_SET(cyclic_drive_state, state); }

void set_cyclic_soc(uint8_t soc) { CYCLIC_DATA_SET(cyclic_soc, soc); }

// Create functions that get the cyclic_data

uint32_t* get_cyclic_speed(void) { return CYCLIC_DATA_GET(cyclic_speed); }

int16_t* get_cyclic_pack_current(void) { return CYCLIC_DATA_GET(cyclic_pack_current); }

uint16_t* get_cyclic_pack_voltage(void) { return CYCLIC_DATA_GET(cyclic_pack_voltage); }
