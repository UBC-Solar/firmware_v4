/**
 * @file    cruise_control_test.h
 * @brief   Cruise control test header file
 *
 * @author  Tony Chen
 * @date    Mar 22, 2026
 */

#ifndef __CRUISE_CONTROL_TEST_H__
#define __CRUISE_CONTROL_TEST_H__
...
#endif // __CRUISE_CONTROL_TEST_H__