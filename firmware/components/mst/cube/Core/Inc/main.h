...
/* Private defines -----------------------------------------------------------*/
#define BALANCE_EN_IN_Pin GPIO_PIN_0
#define BALANCE_EN_IN_GPIO_Port GPIOC
#define SCRUTINEERING_EN_IN_Pin GPIO_PIN_1
#define SCRUTINEERING_EN_IN_GPIO_Port GPIOC
#define FLOATING_ADC_RNG_SEED_Pin GPIO_PIN_0
#define FLOATING_ADC_RNG_SEED_GPIO_Port GPIOA
